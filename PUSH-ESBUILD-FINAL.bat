...
echo.
echo PUSH FINAL - USANDO ESBUILD (SIN TERSER)
echo.
...
echo Creando commit...
git commit -m "Fix: Cambiar minify de terser a esbuild" 2>nul
...
echo.
echo ESTA VEZ SÍ DEBERÍA FUNCIONAR - USAMOS ESBUILD QUE YA VIENE CON VITE
echo.
